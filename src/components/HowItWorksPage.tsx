...
export default function HowItWorksPage({ onNavigateToPrivacyPolicy, onNavigateToCookiePolicy, onNavigateToTerms }: HowItWorksPageProps) {
  const steps = [
    ...
    },
    {
      ...
      description: 'Our expert team carefully evaluates your vehicle details and media. We then submit your vehicle off to all appropriate parties and negitate the price. This typically takes 24-48 hours.',
      icon: Check,
    },
    {
      number: 4,
